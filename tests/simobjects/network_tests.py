...
class TestNetwork(unittest.TestCase):
    def test_node(self):
        ...
        first_node.infect()
        self.assertEqual(first_node.state, nodestate.NodeState.INFECTED)
        first_node.recover()
        self.assertEqual(first_node.state, nodestate.NodeState.RECOVERED)
    ...
    def test_edge_infection(self):
        ...
        self.assertEqual(second_node.state, nodestate.NodeState.SUSCEPTIBLE)
        ...
        self.assertEqual(second_node.state, nodestate.NodeState.INFECTED)
        self.assertEqual(second_node.generation, 1)
